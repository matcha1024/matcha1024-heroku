...
<div class="content">
	...
	ret += r'<br><a href="https://twitter.com/hakuryo_BOT">Twitter( @hakuryo_BOT )</a>  </div>'
	ret += '<div class=license> <p>このページは一分ごとに更新されます。 /  <a href="/hr-delay-license" style="display:inline">利用規約</a> </p> </div>'
	return ret